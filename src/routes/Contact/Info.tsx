        ...
        <div className="contact-info">
            <div className="contact-info__hero">
                ...
                <div className="contact-info__hiring-bubble button">
                    <a className="t--default contact-info__hiring-bubble__text" href="https://drive.google.com/file/d/1Joy0TLwtRjUDR-ELOJdS9ZibIYoAIMcI/view" target="_blacnk" rel="noreferrer">Hiring? Download <span>my resume</span> here</a>
                    <a className="t--default contact-info__hiring-bubble__text-mobile" href="https://drive.google.com/file/d/1Joy0TLwtRjUDR-ELOJdS9ZibIYoAIMcI/view" target="_blacnk" rel="noreferrer">Hiring?</a>
                </div>
